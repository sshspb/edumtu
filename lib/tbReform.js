...
function rwLogBuffer(callback) {
  ...
  .toArray(function(err, result1) {
    ...
    for (var i = 0; i < result1.length; i++) {
      logbuffer += result1[i]._id.contract + " - договор, не указан Тип_договора! Отброшен.\n";
    }
    db.collection('Inet_MUSmetaFin')
    .aggregate([
    ...
    .toArray(function(err, result2) {
      ...
      for (var i = 0; i < result2.length; i++) {
        logbuffer += result2[i]._id.contract + " - договор, не указано Финансирование! Отброшен.\n";
      }
