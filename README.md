...
10. Обновление текста программы делаем по команде `git pull --no-edit origin master`, и, возможно, потребуется `npm install`, если вдруг используется новый npm-модуль. Таким образом, чтобы обновить версию сайта делаем
