### v1.9.7 29 мая 2018 г.
Куприянова Т.Б.:
> Высылаю Вам новый файл `Inet_MURashodFaktLS.txt` (в числе прочих). 
> Это факт расходы. Этим файлом Вы должны раскрывать расходы по КОСГУ для варианта Факт( для отчета Смета). 
> Вариант Смета остается без изменений, там расходы по КОСГУ раскрываете по прежнему файлом `Inet_MURashodLS.txt`

### v1.9.5 28 мая 2018 г.
Возвращаем, вместо тестовых, вывод штатных значений в колонках 
`Контрагент` `Контракт` `Примечание`

### v1.9.4 25 мая 2018 г.
Добавлена возможность сменить пароль у администратора. 

### v1.9.3 22 мая 2018 г.
