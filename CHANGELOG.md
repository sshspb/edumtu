...
- Строка заголовков таблицы фиксируется наверху экрана при прокрутке списка вниз счетов.

Изменения - наше предложение - если закзачику не подойдёт отменим:
- Строка Итоги таблицы фиксируется внизу экрана при прокрутке списка вверх.
