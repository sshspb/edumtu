### v1.12.7 от  2 июля 2018
Добавлены "бэйджи" с количеством договоров в пункты классификатора ВидДеятельнсоти.

### v1.12.6 от 30 июня 2018
Создана утилита lib/edubak.js для резервного копирования коллекций `chiefs` и `users`

### v1.12.1 от 28 июня 2018
- В отчёте Ответственный/ЛицСчёт убрать коды подразделения, которые присутствуют перед номером ЛС
- Поменять местами колонки "Остаток/Месяц" и "Кассовые затраты" (Вариант План)

### v1.12.0 от 27 июня 2018
Организована работа по годам. Импортируемые данные располагаются в подпапках Inet_НОМЕР ГОДА, т.е. Inet_2017, Inet_2018, Inet_2019 и т.д.

### v1.11.2 от 26 июня 2018 
В смете добавлена графа со значением, которое высчитывается путем деления `остатка по смете` на количество оставшихся месяцев в году.

### v1.11.1 от 26 июня 2018 
Нормализация содержимого базы данных

Устранены договора в которых отсутствует хоть один из следующих обязательных параметров :
- Руководитель
- код_факультета
- Тип_договора
- финансирование

Приведено к единому наименованию разное название подразделения в документах с одним и тем же кодом подразделения.
