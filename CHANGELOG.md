...
### edumtu v1.8.0 от 25.04.2018 

Изменения: Согласно служебной записке товарища Куприяновой от 23 апреля 2018 добавлены отчётные формы по расходным записям.

N.B. У товарища Куприяновой новые файлы с данными - разместить в нужную папку.
