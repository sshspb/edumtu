...
3. В каждой записи файла Inet_MUSmetaLSAll расчёт
  "Остаток_по_смете" ("Остаток по смете") = 
    "Вх_Остаток" ("Ост. на начало") +
    "Сумма_назначения" ("Плановая сумма на год") -
    "Затраты_с_обяз" ("Затраты с планом") 
4. В каждой записи файла Inet_MUSmetaLSAll расчёт
  "Остаток_ден" ("Остаток денеж. средств") = 
    "Вх_Остаток" ("Ост. на начало") +
    "Доход_по_статье" ("Поступление денеж срв.") -
    "Затраты_факт" ("Кассовые затраты")
